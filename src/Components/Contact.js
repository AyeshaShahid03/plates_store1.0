...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto pt-md-4 py-0 mb-0">
        <div className="row d-none d-md-block ">
          <div className="col-xl-12" style={{ margin: '50px auto' }}>
            <div className="row ">
              ...
              <div className="col-md-4" style={{}}>
                <div className="customer-card" style={{ margin: 'auto' }}>
                  ...
                  <p>Learn about our shipping and return policies.</p>
                </div>
              </div>
        ...
        <div className="row d-block d-md-none">
          <div className="col-xl-12" style={{ margin: '30px auto 30px auto' }}>
                    ...
                    <div className="col-3">
                      <h3 className="mt-3">
                        ...
                        >
                          ...
                          <path
                            d="M44.9747 37.9191C45.5984 36.4044 45.937 34.7828 45.937 33.0008C45.937 31.7178 45.741 30.4882 45.4024 29.3477C44.2441 29.615 43.0323 29.7576 41.7671 29.7576C39.176 29.7604 36.6223 29.1402 34.3211 27.9492C32.0199 26.7583 30.0388 25.0316 28.5447 22.9147C26.9464 26.7819 23.9313 29.8927 20.1158 31.6109C20.0445 32.0564 20.0445 32.5375 20.0445 33.0008C20.0445 34.7021 20.3796 36.3867 21.0307 37.9585C21.6818 39.5303 22.636 40.9585 23.839 42.1615C26.2686 44.591 29.5638 45.956 32.9997 45.956C34.8708 45.956 36.6706 45.5461 38.2922 44.8155C39.308 46.7579 39.7713 47.7201 39.7356 47.7201C36.8132 48.7002 34.55 49.1814 32.9997 49.1814C28.6872 49.1814 24.5708 47.4885 21.5414 44.4413C19.6988 42.6043 18.3291 40.348 17.5497 37.8657H15.1797V29.7576H17.1221C17.7106 26.893 19.0635 24.2412 21.0375 22.0836C23.0114 19.9259 25.5326 18.3428 28.3336 17.5023C31.1346 16.6619 34.1108 16.5953 36.9466 17.3098C39.7823 18.0243 42.3718 19.4931 44.4401 21.5604C46.6858 23.7972 48.2176 26.6499 48.8417 29.7576H50.8197V37.8657H50.7128L44.3688 43.6928L34.9242 42.6236V39.6477H43.5313L44.9747 37.9191ZM28.1348 32.591C28.6694 32.591 29.1862 32.8048 29.5604 33.1968C29.9365 33.576 30.1475 34.0884 30.1475 34.6224C30.1475 35.1565 29.9365 35.6689 29.5604 36.048C29.1862 36.4223 28.6694 36.6361 28.1348 36.6361C27.0122 36.6361 26.1033 35.7451 26.1033 34.6224C26.1033 33.4998 27.0122 32.591 28.1348 32.591ZM37.8467 32.591C38.9694 32.591 39.8604 33.4998 39.8604 34.6224C39.8604 35.7451 38.9694 36.6361 37.8467 36.6361C36.7241 36.6361 35.8152 35.7451 35.8152 34.6224C35.8152 34.0837 36.0293 33.5669 36.4103 33.186C36.7912 32.805 37.3079 32.591 37.8467 32.591Z"
                            fill="#FCF7EF"
                          />
                        </svg>
                      </h3>
              ...
              <div className="col-md-4 " style={{}}>
                <div className="customer-card1">
                  <div className=" d-flex align-items-center">
                    <div className="col-3">
                      <h3 className="mt-3">
                        <img src={faqs} className="img-fluid" />
                      </h3>
                    </div>
                    <div className="col-9 ps-3">
                      <h4>FAQs</h4>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-10" style={{ margin: '40px auto' }}>
              ...
              >
                <div
                  className="social-icons-card col-md-3 col-6 text-center"
                  onClick={handleChat}
                >
                ...
                <div className="social-icons-card col-md-3 col-6 text-center">
                  <Link to={'mailto:info@platebuy.com'}>
                    <h3>
                      <svg
                        width={105}
                        height={105}
